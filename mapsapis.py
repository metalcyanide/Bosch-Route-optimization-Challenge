...
latlongdict = dict()
latlongdict, needtoappendcity = getlatlong(apikey,file_location = "/home/metalcyanide/github/Route-optimization-Inter-IIT/sample.txt" )
...
timedict = dict()
timedict = genDistanceMatrix(apikey,getdistance = 0,needtoappendcity = needtoappendcity ,file_location = "/home/metalcyanide/github/Route-optimization-Inter-IIT/sample.txt" )
print(timedict, file = timetxt)
timetxt.close()

distancetxt = open('distancedict.txt', 'w') 
distancedict = dict()
distancedict = genDistanceMatrix(apikey, needtoappendcity = needtoappendcity,file_location = "/home/metalcyanide/github/Route-optimization-Inter-IIT/sample.txt" )
